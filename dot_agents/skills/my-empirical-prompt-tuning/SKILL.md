---
name: my-empirical-prompt-tuning
...
参照元: [mizchi/skills empirical-prompt-tuning](https://github.com/mizchi/skills/blob/main/empirical-prompt-tuning/SKILL-ja.md) を本環境に合わせて取り込み。
...
- `my-retrospective-codify` — タスク後の学び固定化。本 skill は「プロンプト開発中の改善」、my-retrospective-codify は「タスク終了後の知見抽出」、と使い分ける

## References

- [Anthropic Prompt Engineering Guide](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/overview) — プロンプト設計の原則、明瞭性・具体性・例示の指針
